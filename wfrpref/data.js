...
$(document).ready(function () {
    let lists = [career, skill, talent, spell, miracle, condition, weapon, armour, trait, weaponQual, armourQual, endeavour, betweenAdventureEvent]
    let listTypes = ["career", "skill", "talent", "spell", "miracle", "condition", "weapon", "armour", "trait", "qual", "armQual", "endeavour", "betweenAdventureEvent"]
...
var endeavour = [
    ...
    },
    {
        ...
        "description": ["A Favour is a future burden you take on in return for immediate assistance of some sort. In the Old World, breaking one’s sworn word is considered bad form and carries significant social ramifications. No-one trusts oath breakers, meaning your Status is reduced by 1 (see page 49). Powerful and dangerous folks tend to take it very, very poorly if someone refuses a Favour owed them, so bloody consequences may follow.",
            ...
            "<eh>A Minor Favour</eh> represents a simple task that can be completed in no more than a few hours. Perhaps you need volunteer at a Shallyan mercy-house or put in a good word for someone. With the GM’s permission, you may undertake an Endeavour to pay off this favour.",
            "<eh>A Major Favour</eh> is a more time-consuming or risky undertaking. It could take up to several weeks to achieve and may involve travel. Perhaps you are needed to act as lookout on a string of burglaries, to convince the Stevedores’ and Teamsters’ Guild to back down from a guild war, or to transport a package to a different city. With the GM’s permission, you may undertake two or more consecutive Endeavours to pay off this favour.",
            "<eh>A Significant Favour</eh> is relatively rare and will almost certainly involve risking life and limb. Months of travel may be involved, and major violence is likely. Perhaps you will be asked to eliminate a rival gang boss, wipe out a Goblin encampment, or instigate a riot. Significant Favours cannot be paid off via Endeavours; they are roleplayed out as full adventures."
    ]
    },
    {
        "name": "Income",
